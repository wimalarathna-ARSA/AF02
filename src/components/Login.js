        ...
        <div className={`${isDarkMode ? 'bg-gray-800/90 border-gray-700/50' : 'bg-white/95 border-gray-200/50'} backdrop-blur-lg rounded-2xl shadow-xl border transition-all duration-300 hover:shadow-2xl`}>
          <div className="p-8">
            <div className="text-center mb-8">
              ...
              <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} mt-2 text-sm`}>Sign in to continue your journey</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="mt-2 text-right">
                  <Link 
                    to="/forgot-password" 
                    className={`text-xs ${isDarkMode ? 'text-teal-400 hover:text-teal-300' : 'text-blue-600 hover:text-blue-500'} font-medium transition-colors`}
                  >
                    Forgot password?
                  </Link>
                </div>
